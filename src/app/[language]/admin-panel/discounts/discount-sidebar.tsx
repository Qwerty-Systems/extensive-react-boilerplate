...
export default function DiscountSidebar({
  ...
  const { t } = useTranslation("admin-panel-Discounts");
    ...
    <Box p={3}>
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Typography variant="h6">
          {Discount ? t("sidebar.DiscountDetails") : t("sidebar.newDiscount")}
        </Typography>
      ...
      {isEditing ? (
        ...
        <>
          <Typography variant="subtitle1" gutterBottom>
            {Discount.firstName} {Discount.lastName}
          </Typography>
