...
// import { Vendor } from "@/services/api/types/vendor";
// import { RoleEnum } from "@/services/api/types/role";
// import withPageRequiredAuth from "@/services/auth/with-page-required-auth";
// import { useTranslation } from "@/services/i18n/client";
// import { useGetVendorsQuery } from "./queries/queries";
// import { useDeleteVendorService } from "@/services/api/services/vendor";
...
//       queryClient.setQueryData(["vendors", { sort, filter }], {
//         ...previousData,
//         pages: previousData?.pages.map((page: any) => ({
//           ...page,
//           data: page?.data.filter((item: Vendor) => item.id !== vendor.id),
//         })),
//       });

//       await fetchVendorDelete({ id: vendor.id! });
//     }
//   };
...
//           size="small"
//           LinkComponent={Link}
//           href={`/admin-panel/vendors/edit/${vendor.id}`}
//           color="primary"
//         >
...
//         orderBy: (sortModel[0]?.field as keyof Vendor) || "createdAt",
//       },
//     });
...
//     {
//       field: "contactEmail",
//       headerName: t("table.contactEmail"),
//       flex: 1,
//       minWidth: 250,
//     },
//     {
//       field: "paymentTerms",
//       headerName: t("table.paymentTerms"),
//       flex: 1,
//       minWidth: 150,
//     },
//     {
...
//       headerName: "",
//       width: 120,
//       renderCell: (params) => <Actions vendor={params.row} />,
//       sortable: false,
//     },
//   ];
...
//             rows={result}
//             columns={columns}
//             loading={isFetching极速赛车开奖直播官网age}
//             sortModel={sortModel}
...
// export default withPageRequiredAuth(Vendors, {
